...
import prv.mark.util.AppNumberUtils;
...
public class ApplicationScheduler {
    ...
    public final void run() {
        ...
        LOGGER.debug("");
        LOGGER.debug("******************************************************");
        LOGGER.debug("*** ApplicationScheduler.run() entry               ***");
        ...
        try {
            ...
            jobParametersBuilder.addLong("id", AppNumberUtils.toLong(jobIdParameter));
    ...
    private void routeException(String logmsg, Exception e) {
        AppExceptionRouter.logAndThrowApplicationException(LOGGER, logmsg, e);
    }
}
